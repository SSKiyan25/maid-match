...
interface EmployerPhotosProps {
    photos: UserPhoto[];
}

export default function EmployerPhotos({ photos }: EmployerPhotosProps) {
        ...
        return (
            <div className="flex flex-col items-center justify-center py-12 text-center">
                ...
                <p className="text-muted-foreground max-w-md">
                    This employer hasn't added any photos to their profile yet.
                </p>
            </div>
        );
    }
                    ...
                    {galleryPhotos.map((photo) => (
                        ...
                        >
                            <img
                                ...
                                alt={photo.caption || "Employer photo"}
